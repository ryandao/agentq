...
/*
 * Documentation:
 * Drawer — https://app.subframe.com/a6f9d7916cd9/library?component=Drawer_1e71b2cb-8d72-4e67-b368-8805179e9444
 */
...
interface ContentProps extends React.ComponentProps<
    typeof SubframeCore.Drawer.Content
> {
...
interface DrawerRootProps extends React.ComponentProps<
    typeof SubframeCore.Drawer.Root
> {
    children?: React.ReactNode;
    open?: boolean;
