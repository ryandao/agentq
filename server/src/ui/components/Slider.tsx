...
/*
 * Documentation:
 * Slider — https://app.subframe.com/a6f9d7916cd9/library?component=Slider_f4092874-0320-449e-a0c5-b435987c4cfb
 */
...
interface RangeProps extends React.ComponentProps<
    typeof SubframeCore.Slider.Range
> {
    className?: string;
}
...
interface ThumbProps extends React.ComponentProps<
    typeof SubframeCore.Slider.Thumb
> {
    className?: string;
}
...
interface TrackProps extends React.ComponentProps<
    typeof SubframeCore.Slider.Track
> {
    className?: string;
}
...
interface SliderRootProps extends React.ComponentProps<
    typeof SubframeCore.Slider.Root
> {
    value?: number[];
