...
/*
 * Documentation:
 * Toggle Group — https://app.subframe.com/a6f9d7916cd9/library?component=Toggle+Group_2026f10a-e3cc-4c89-80da-a7259acae3b7
 */
...
interface ItemProps extends React.ComponentProps<
    typeof SubframeCore.ToggleGroup.Item
> {
    disabled?: boolean;
...
interface ToggleGroupRootProps extends React.ComponentProps<
    typeof SubframeCore.ToggleGroup.Root
> {
    children?: React.ReactNode;
    value?: string;
