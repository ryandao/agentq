...
/*
 * Documentation:
 * Checkbox Card — https://app.subframe.com/a6f9d7916cd9/library?component=Checkbox+Card_de0b4dfb-3946-4702-be52-5678dd71925a
 */
...
interface CheckboxCardRootProps extends React.ComponentProps<
    typeof SubframeCore.Checkbox.Root
> {
    disabled?: boolean;
    checked?: boolean;
