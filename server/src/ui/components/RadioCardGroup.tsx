...
/*
 * Documentation:
 * Radio Card Group — https://app.subframe.com/a6f9d7916cd9/library?component=Radio+Card+Group_6d5193b8-6043-4dc1-aad5-7f902ef872df
 */
...
interface RadioCardProps extends React.ComponentProps<
    typeof SubframeCore.RadioGroup.Item
> {
    disabled?: boolean;
    checked?: boolean;
    hideRadio?: boolean;
...
interface RadioCardGroupRootProps extends React.ComponentProps<
    typeof SubframeCore.RadioGroup.Root
> {
    children?: React.ReactNode;
    value?: string;
