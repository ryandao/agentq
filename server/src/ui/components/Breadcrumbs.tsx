...
/*
 * Documentation:
 * Breadcrumbs — https://app.subframe.com/a6f9d7916cd9/library?component=Breadcrumbs_8898334b-a66f-4ee8-8bd1-afcfa8e37cc0
 */
...
interface DividerProps extends React.ComponentProps<
    typeof FeatherChevronRight
> {
    className?: string;
}
