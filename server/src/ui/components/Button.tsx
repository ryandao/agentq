...
/*
 * Documentation:
 * Button — https://app.subframe.com/a6f9d7916cd9/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
        ...
        return (
            <button
                className={SubframeUtils.twClassNames(
                    ...
                    {
                        "h-6 w-auto flex-row flex-nowrap gap-1 px-2 py-0":
                            size === "small",
