...
/*
 * Documentation:
 * Progress — https://app.subframe.com/a6f9d7916cd9/library?component=Progress_60964db0-a1bf-428b-b9d5-f34cdf58ea77
 */
...
interface IndicatorProps extends React.ComponentProps<
    typeof SubframeCore.Progress.Indicator
> {
    className?: string;
}
...
interface ProgressRootProps extends React.ComponentProps<
    typeof SubframeCore.Progress.Root
> {
    value?: number;
    className?: string;
}
