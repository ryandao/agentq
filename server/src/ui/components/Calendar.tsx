...
/*
 * Documentation:
 * Calendar — https://app.subframe.com/a6f9d7916cd9/library?component=Calendar_5a87e517-ace2-49af-adcf-076c97ec3921
 */
        ...
        <SubframeCore.Calendar
            ...
            classNames={{
                ...
                button_next:
                    "inline-flex items-center justify-center h-8 w-8 bg-transparent rounded border-none bg-transparent hover:bg-neutral-50 active:bg-neutral-100 border-none",
                chevron:
                    "text-[18px] font-[500] leading-[18px] text-neutral-600",
                ...
                day_button:
                    "flex h-8 w-8 cursor-pointer items-center justify-center gap-2 rounded-lg border-none hover:bg-neutral-100 group-[.selected]:bg-brand-600 group-[.selected]:text-white group-[.selected]:hover:bg-brand-700 group-[.selected]:hover:text-white group-[.outside]:bg-transparent group-[.outside.selected]:bg-brand-100 group-[.outside.range-start]:bg-brand-100 group-[.outside.range-end]:bg-brand-100 group-[.outside.range-start]:rounded-l-lg group-[.outside.range-start]:rounded-r-none group-[.outside.range-end]:rounded-l-none group-[.outside.range-end]:rounded-r-lg group-[.outside]:!text-neutral-400 group-[.outside]:hover:bg-neutral-100 group-[.range-middle.selected]:bg-brand-100 group-[.range-middle.selected]:text-brand-700 group-[.range-middle.selected]:hover:bg-brand-200 group-[.range-middle.selected]:hover:text-brand-700 group-[.range-middle.selected]:rounded-none",
                selected: "selected",
                outside: "outside",
                range_start: "range-start bg-brand-100 rounded-l-lg",
                range_middle: "range-middle",
                range_end: "range-end bg-brand-100 rounded-r-lg",
            }}
            {...otherProps}
        />
    );
