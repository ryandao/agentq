...
/*
 * Documentation:
 * Switch — https://app.subframe.com/a6f9d7916cd9/library?component=Switch_7a464794-9ea9-4040-b1de-5bfb2ce599d9
 */
...
interface ThumbProps extends React.ComponentProps<
    typeof SubframeCore.Switch.Thumb
> {
    className?: string;
}
...
interface SwitchRootProps extends React.ComponentProps<
    typeof SubframeCore.Switch.Root
> {
    checked?: boolean;
