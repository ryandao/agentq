...
/*
 * Documentation:
 * Fullscreen Dialog — https://app.subframe.com/a6f9d7916cd9/library?component=Fullscreen+Dialog_3f094173-71de-4378-a09a-05c482f7a137
 */
...
interface FullscreenDialogRootProps extends React.ComponentProps<
    typeof SubframeCore.FullScreenDialog.Root
> {
