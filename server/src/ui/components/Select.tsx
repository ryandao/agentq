...
/*
 * Documentation:
 * Select — https://app.subframe.com/a6f9d7916cd9/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
...
interface ContentProps extends React.ComponentProps<
    typeof SubframeCore.Select.Content
> {
...
interface ItemProps extends Omit<
    React.ComponentProps<typeof SubframeCore.Select.Item>,
    "value"
> {
...
interface ItemTextProps extends React.ComponentProps<
    typeof SubframeCore.Select.ItemText
> {
    children?: React.ReactNode;
    className?: string;
}
...
interface TriggerValueProps extends React.ComponentProps<
    typeof SubframeCore.Select.Value
> {
    placeholder?: React.ReactNode;
    className?: string;
}
...
interface SelectRootProps extends React.ComponentProps<
    typeof SubframeCore.Select.Root
> {
    disabled?: boolean;
    error?: boolean;
