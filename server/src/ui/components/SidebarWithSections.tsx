...
/*
 * Documentation:
 * Sidebar with sections — https://app.subframe.com/a6f9d7916cd9/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
 */
    ...
    return (
        <div
            className={SubframeUtils.twClassNames(
                ...
                {
                    "bg-brand-50 hover:bg-brand-50 active:bg-brand-100":
                        selected,
                },
                className,
            )}
